  ...
  return (
    <div style={{}} className="page-section" id="section-accommodation">
      <Container>
        ...
        <Block>
          V areáli svadby bude možné ubytovať iba malý počet hostí; pre ďalších
          máme na noc zo soboty na nedeľu bývanie v okolitých obciach. Ubytovať
          sa bude možné v sobotu od 15, odubytovanie potom bude v nedeľu do 15.
          Aby sme vedeli zorganizovať dostupné kapacity, uveďte prosím vo
